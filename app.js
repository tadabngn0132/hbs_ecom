...
var database = process.env.MONGODB_URI || "mongodb://localhost:27017/web";
...
mongoose
  .connect(database)
  .then(() => {
    log("Connection database successfully");
    log(
      "Connected to:",
      database.includes("mongodb+srv") ? "MongoDB Atlas" : "Local MongoDB"
    );
  })
